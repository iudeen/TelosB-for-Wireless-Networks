...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x404382a8, const void *arg_0x40438440);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x4048d5c0) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x405dc840), 
int (*key_eq_fn)(void *arg_0x405dcc88, void *arg_0x405dce00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x407129b8, int arg_0x40712b10);
static double RandomUniform(void );
...
typedef TMilli SendToRadioC$TimerPeriodic$precision_tag;
...
static void SendToRadioC$AMControl$startDone(error_t error);
#line 117
static void SendToRadioC$AMControl$stopDone(error_t error);
# 49 "/opt/tinyos-2.1.1/tos/interfaces/Boot.nc"
static void SendToRadioC$Boot$booted(void );
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static void SendToRadioC$AMSend$sendDone(
#line 92
message_t * msg, 
...
static void SendToRadioC$TimerPeriodic$fired(void );
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
static 
#line 63
message_t * 
...
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t /*SendToRadioAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 60
message_t * msg, 
...
static void /*SendToRadioAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 85
message_t * msg, 
...
# 83 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
static error_t SendToRadioC$AMControl$start(void );
...
SendToRadioC$Packet$getPayload(
#line 110
message_t * msg, 
...
uint8_t len);
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t SendToRadioC$AMSend$send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
# 53 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
static void SendToRadioC$TimerPeriodic$startPeriodic(uint32_t dt);
# 56 "/opt/tinyos-2.1.1/tos/interfaces/Leds.nc"
static void SendToRadioC$Leds$led0Toggle(void );
#line 72
static void SendToRadioC$Leds$led1Toggle(void );
#line 89
static void SendToRadioC$Leds$led2Toggle(void );
# 13 "SendToRadioC.nc"
uint16_t SendToRadioC$counter[1000];
message_t SendToRadioC$pkt[1000];
bool SendToRadioC$busy[1000];

static inline void SendToRadioC$Boot$booted(void );


static inline void SendToRadioC$AMControl$startDone(error_t err);
...
static inline void SendToRadioC$AMControl$stopDone(error_t err);


static inline void SendToRadioC$TimerPeriodic$fired(void );
#line 46
static inline void SendToRadioC$AMSend$sendDone(message_t *msg, error_t error);
...
static inline message_t *SendToRadioC$Receive$receive(message_t *msg, void *payload, uint8_t len);
# 44 "/opt/tinyos-2.1.1/tos/chips/atm128/timer/HplAtm128TimerCtrl8.nc"
...
static am_addr_t ActiveMessageAddressC$amAddress(void );
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static void /*SendToRadioAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
static error_t /*SendToRadioAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 56
message_t * msg, 
...
static void /*SendToRadioAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 151
static void /*SendToRadioAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 147
message_t * amsg, 
...
static error_t /*SendToRadioAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*SendToRadioAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
...
#line 32
# 51 "/opt/tinyos-2.1.1/tos/chips/atm128/pins/sim/HplAtm128GeneralIOPinP.nc"
static __inline void /*HplAtm128GeneralIOC.PortA.Bit2*/HplAtm128GeneralIOPinP$2$IO$toggle(void )
#line 51
{
#line 51
...
{
  LedsP$Led0$toggle();
  sim_log_debug(112U, "LedsC", "LEDS: Led""0"" %s.\n", LedsP$Led0$get() ? "off" : "on");
#line 75
  ;
}

# 56 "/opt/tinyos-2.1.1/tos/interfaces/Leds.nc"
inline static void SendToRadioC$Leds$led0Toggle(void ){
#line 56
...
{
  LedsP$Led2$toggle();
  sim_log_debug(118U, "LedsC", "LEDS: Led""2"" %s.\n", LedsP$Led2$get() ? "off" : "on");
#line 105
  ;
}

# 89 "/opt/tinyos-2.1.1/tos/interfaces/Leds.nc"
inline static void SendToRadioC$Leds$led2Toggle(void ){
#line 89
...
#line 53
{
  if (len == sizeof(SendToRadioMsg )) {
      ...
      if (__nesc_ntoh_uint16(btrpkt->nodeid.nxdata) == 24 || __nesc_ntoh_uint16(btrpkt->nodeid.nxdata) == 25) {
          SendToRadioC$Leds$led2Toggle();
        }
      else 
        {
          SendToRadioC$Leds$led0Toggle();
        }
    }
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x4094e158, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x4094e158) {
#line 67
    case 6:
#line 67
      __nesc_result = SendToRadioC$Receive$receive(msg, payload, len);
#line 67
      break;
#line 67
    default:
#line 67
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x4094e158, msg, payload, len);
#line 67
      break;
#line 67
    }
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x4094e7f0, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x4094e7f0, msg, payload, len);
#line 67
...
# 83 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
inline static error_t SendToRadioC$AMControl$start(void ){
#line 83
  unsigned char __nesc_result;
#line 83
...
# 53 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void SendToRadioC$TimerPeriodic$startPeriodic(uint32_t dt){
#line 53
...
{
  if (err == SUCCESS) {
      SendToRadioC$TimerPeriodic$startPeriodic(TIMER_PERIOD_MILLI);
    }
  else {
      SendToRadioC$AMControl$start();
    }
}
...
#line 92
  SendToRadioC$AMControl$startDone(error);
#line 92
}
#line 92
# 88 "/opt/tinyos-2.1.1/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 117
  SendToRadioC$AMControl$stopDone(error);
#line 117
}
#line 117
...
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x4094ac70, message_t * msg, error_t error){
#line 99
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x4094ac70, msg, error);
#line 99
}
#line 99
...
inline static void SendToRadioC$Leds$led1Toggle(void ){
#line 72
...
#line 46
{
  if (&SendToRadioC$pkt[sim_node()] == msg) {
      SendToRadioC$busy[sim_node()] = FALSE;
    }
  SendToRadioC$Leds$led1Toggle();
}

# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void /*SendToRadioAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 99
  SendToRadioC$AMSend$sendDone(msg, error);
#line 99
}
#line 99
...
#line 57
{
  /*SendToRadioAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x40c4aa90, message_t * msg, error_t error){
#line 89
  switch (arg_0x40c4aa90) {
#line 89
    case 0U:
#line 89
      /*SendToRadioAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 89
      break;
#line 89
    default:
#line 89
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x40c4aa90, msg, error);
#line 89
      break;
#line 89
    }
...
# 64 "/opt/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x407ae630){
#line 64
  switch (arg_0x407ae630) {
#line 64
...
#line 64
    default:
#line 64
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x407ae630);
#line 64
      break;
#line 64
    }
...
#line 56
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x40c47490, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x40c47490, addr, msg, len);
#line 69
...
#line 288
{
  ...
  sim_log_debug(166U, "CpmModelC", "Handling reception event @ %s.\n", sim_time_string());
  while (list != (void *)0) {
      if (list->next == mine) {
          predecessor = list;
        }
...
#line 303
    if (mine == CpmModelC$outstandingReceptionHead[sim_node()]) {
        ...
        sim_log_error(167U, "CpmModelC", "Incoming packet list structure is corrupted: entry is not the head and no entry points to it.\n");
      }
    }
#line 309
  sim_log_debug(168U, "CpmModelC,SNRLoss", "Packet from %i to %i\n", (int )mine->source, (int )sim_node());
  if (!CpmModelC$checkReceive(mine)) {
      sim_log_debug(169U, "CpmModelC,SNRLoss", " - lost packet from %i as SNR was too low.\n", (int )mine->source);
      mine->lost = 1;
    }
  if (! mine->lost) {
...
#line 319
      ...
      sim_log_debug_clear(170U, "CpmModelC,SNRLoss", "  -signaling reception\n");
      CpmModelC$Model$receive(mine->msg);
      if (mine->ack) {
          sim_log_debug_clear(171U, "CpmModelC", " acknowledgment requested, ");
        }
      else {
          sim_log_debug_clear(172U, "CpmModelC", " no acknowledgment requested.\n");
        }
...
#line 274
  ...
  sim_log_debug(158U, "TossimPacketModelC", "PACKET: Signaling send done at %llu.\n", sim_time());
...
#line 245
{
  ...
  sim_log_debug(156U, "TossimPacketModelC", "PACKET: Broadcasting packet to everyone.\n");
  ...
  sim_log_debug(157U, "TossimPacketModelC", "PACKET: Send done at %llu.\n", evt->time);
...
#line 235
        TossimPacketModelC$sending[sim_node()] = (void *)0;
        sim_log_debug(155U, "TossimPacketModelC", "PACKET: Failed to send packet due to busy channel.\n");
...
#line 186
  ...
  backoff += sim_csma_init_low();
  backoff *= sim_ticks_per_sec() / sim_csma_symbols_per_sec();
  sim_log_debug(154U, "TossimPacketModelC", "Starting CMSA with %lli.\n", backoff);
...
#line 231
  sim_log_debug(165U, "CpmModelC,SNR", "SNR is %lf, PRR is %lf\n", SNR, prr_hat);
  if (prr_hat > 1) {
    prr_hat = 1.1;
    }
  else {
...
#line 291
      ...
      if (msg != TossimPacketModelC$sending[sim_node()]) {
          ...
          sim_log_debug(159U, "TossimPacketModelC", "Requested ack for 0x%x, but outgoing packet is 0x%x.\n", msg, TossimPacketModelC$sending[sim_node()]);
        }
    }
}
...
#line 149
  sim_log_debug(162U, "CpmModelC,SNRLoss", "SNR is %lf, ARR is %lf\n", SNR, prr_hat);
  if (prr_hat > 1) {
    prr_hat = 1.1;
    }
  else {
...
#line 56
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t SendToRadioC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = /*SendToRadioAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 69
...
# 115 "/opt/tinyos-2.1.1/tos/interfaces/Packet.nc"
inline static void * SendToRadioC$Packet$getPayload(message_t * msg, uint8_t len){
#line 115
  void *__nesc_result;
#line 115
...
#line 31
{
  SendToRadioC$counter[sim_node()]++;
  if (!SendToRadioC$busy[sim_node()]) {
      SendToRadioMsg *btrpkt = (SendToRadioMsg *)SendToRadioC$Packet$getPayload(&SendToRadioC$pkt[sim_node()], sizeof(SendToRadioMsg ));

#line 35
      __nesc_hton_uint16(btrpkt->counter.nxdata, SendToRadioC$counter[sim_node()]);
      __nesc_hton_uint16(btrpkt->nodeid.nxdata, TOS_NODE_ID);
      SendToRadioC$AMSend$send(AM_BROADCAST_ADDR, &SendToRadioC$pkt[sim_node()], sizeof(SendToRadioMsg ));
      sim_log_debug(119U, "SendToRadio", "%s %d have sent packet %d\n", __FUNCTION__, __nesc_hton_uint16(btrpkt->nodeid.nxdata, TOS_NODE_ID), __nesc_ntoh_uint16(btrpkt->counter.nxdata));
    }


  if (
#line 41
  SendToRadioC$AMSend$send(AM_BROADCAST_ADDR, 
  &SendToRadioC$pkt[sim_node()], sizeof(SendToRadioMsg )) == SUCCESS) {
      SendToRadioC$busy[sim_node()] = TRUE;
    }
}
...
# 72 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40b333a8){
#line 72
  switch (arg_0x40b333a8) {
#line 72
    case 0U:
#line 72
      SendToRadioC$TimerPeriodic$fired();
#line 72
      break;
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40b333a8);
#line 72
      break;
#line 72
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
inline static void /*SendToRadioAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 92
...
inline static void /*SendToRadioAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 151
...
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static error_t /*SendToRadioAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 64
  unsigned char __nesc_result;
#line 64
...
{
  LedsP$Led1$toggle();
  sim_log_debug(115U, "LedsC", "LEDS: Led""1"" %s.\n", LedsP$Led1$get() ? "off" : "on");
#line 90
  ;
}
...
#line 118
{
  ...
  sim_log_debug(160U, "CpmModelC", "IN: noise_hash_generation()\n");
  ...
  sim_log_debug(161U, "CpmModelC,Tal", "%s: OUT: noise_hash_generation(): %lf\n", sim_time_string(), noise_val);
...
#line 47
{
  /*SendToRadioAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*SendToRadioAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*SendToRadioAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module SendToRadioC */
  if (!strcmp(varname, "SendToRadioC$counter"))
  {
    *addr = (uintptr_t)&SendToRadioC$counter[__nesc_mote];
    *size = sizeof(SendToRadioC$counter[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SendToRadioC$pkt"))
  {
    *addr = (uintptr_t)&SendToRadioC$pkt[__nesc_mote];
    *size = sizeof(SendToRadioC$pkt[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SendToRadioC$busy"))
  {
    *addr = (uintptr_t)&SendToRadioC$busy[__nesc_mote];
    *size = sizeof(SendToRadioC$busy[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module SendToRadioC */
  memset((void *)&SendToRadioC$counter[__nesc_mote], 0, sizeof SendToRadioC$counter[__nesc_mote]);
  memset((void *)&SendToRadioC$pkt[__nesc_mote], 0, sizeof SendToRadioC$pkt[__nesc_mote]);
  SendToRadioC$busy[__nesc_mote] = FALSE;
