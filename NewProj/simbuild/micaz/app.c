...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x4046f2a8, const void *arg_0x4046f440);
#line 780
__extension__ 
#line 797
__extension__ 
...
# 326 "/usr/include/i386-linux-gnu/bits/mathcalls.h" 3
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x40613840), 
int (*key_eq_fn)(void *arg_0x40613c88, void *arg_0x40613e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x407499b8, int arg_0x40749b10);
static inline double RandomUniform(void );
...
typedef TMilli MyTimerC$Timer0$precision_tag;
typedef TMilli MyTimerC$Timer1$precision_tag;
...
static void MyTimerC$Timer0$fired(void );
# 49 "/opt/tinyos-2.1.1/tos/interfaces/Boot.nc"
static void MyTimerC$Boot$booted(void );
# 64 "/opt/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
static void MyTimerC$TogLed1$runTask(void );
# 72 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
static void MyTimerC$Timer1$fired(void );
# 64 "/opt/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
static void MyTimerC$TogLed0$runTask(void );
# 51 "/opt/tinyos-2.1.1/tos/interfaces/Init.nc"
...
enum SimSchedulerBasicP$__nesc_unnamed4327 {
  ...
  SimSchedulerBasicP$NUM_TASKS = 4U, 
...
# 62 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
static void MyTimerC$Timer0$startOneShot(uint32_t dt);
# 56 "/opt/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
static error_t MyTimerC$TogLed1$postTask(void );
# 53 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
static void MyTimerC$Timer1$startPeriodic(uint32_t dt);
#line 67
static void MyTimerC$Timer1$stop(void );
# 56 "/opt/tinyos-2.1.1/tos/interfaces/Leds.nc"
static void MyTimerC$Leds$led0Toggle(void );
#line 72
static void MyTimerC$Leds$led1Toggle(void );
#line 89
static void MyTimerC$Leds$led2Toggle(void );
# 56 "/opt/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
static error_t MyTimerC$TogLed0$postTask(void );
# 24 "MyTimerC.nc"
enum MyTimerC$__nesc_unnamed4328 {
#line 24
  MyTimerC$TogLed0 = 0U
};
#line 24
typedef int MyTimerC$__nesc_sillytask_TogLed0[MyTimerC$TogLed0];





enum MyTimerC$__nesc_unnamed4329 {
#line 30
  MyTimerC$TogLed1 = 1U
};
#line 30
typedef int MyTimerC$__nesc_sillytask_TogLed1[MyTimerC$TogLed1];
#line 14
uint8_t MyTimerC$counter[1000];
uint8_t MyTimerC$time[1000];
static inline void MyTimerC$Boot$booted(void );
...
static inline void MyTimerC$TogLed0$runTask(void );





static inline void MyTimerC$TogLed1$runTask(void );
...
static inline void MyTimerC$Timer0$fired(void );
#line 49
static inline void MyTimerC$Timer1$fired(void );
# 31 "/opt/tinyos-2.1.1/tos/interfaces/GeneralIO.nc"
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x409887f0, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x409887f0, msg, payload, len);
#line 67
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x40988158, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x40988158, msg, payload, len);
#line 67
...
# 56 "/opt/tinyos-2.1.1/tos/interfaces/Leds.nc"
inline static void MyTimerC$Leds$led0Toggle(void ){
#line 56
...
static inline void MyTimerC$TogLed0$runTask(void )
{
  sim_log_debug(110U, "MyTimerC", "LED 0 Toggle \n");
  MyTimerC$Leds$led0Toggle();
}
...
{
  LedsP$Led1$toggle();
  sim_log_debug(122U, "LedsC", "LEDS: Led""1"" %s.\n", LedsP$Led1$get() ? "off" : "on");
#line 90
  ;
}

# 72 "/opt/tinyos-2.1.1/tos/interfaces/Leds.nc"
inline static void MyTimerC$Leds$led1Toggle(void ){
#line 72
...
static inline void MyTimerC$TogLed1$runTask(void )
{
  sim_log_debug(111U, "MyTimerC", "LED 1 Toggle \n");
  MyTimerC$Leds$led1Toggle();
}
...
# 64 "/opt/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x407e5630){
#line 64
  switch (arg_0x407e5630) {
#line 64
    case MyTimerC$TogLed0:
#line 64
      MyTimerC$TogLed0$runTask();
#line 64
      break;
#line 64
    case MyTimerC$TogLed1:
#line 64
      MyTimerC$TogLed1$runTask();
#line 64
      break;
#line 64
...
#line 64
    default:
#line 64
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x407e5630);
#line 64
      break;
#line 64
    }
...
#line 44
# 62 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void MyTimerC$Timer0$startOneShot(uint32_t dt){
#line 62
...
{
  LedsP$Led2$toggle();
  sim_log_debug(125U, "LedsC", "LEDS: Led""2"" %s.\n", LedsP$Led2$get() ? "off" : "on");
#line 105
  ;
}

# 89 "/opt/tinyos-2.1.1/tos/interfaces/Leds.nc"
inline static void MyTimerC$Leds$led2Toggle(void ){
#line 89
...
static inline void MyTimerC$Timer0$fired(void )
{
  if (MyTimerC$counter[sim_node()] < 3) {
      MyTimerC$counter[sim_node()]++;
      sim_log_debug(112U, "MyTimerC", "One shot Timer 0 fired @ %s \n", sim_time_string());
      MyTimerC$Leds$led2Toggle();
      sim_log_debug(113U, "MyTimerC", "Led2 Toggle \n");
      MyTimerC$Timer0$startOneShot(2048);
    }
}
...
# 67 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void MyTimerC$Timer1$stop(void ){
#line 67
...
#line 67
# 56 "/opt/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
inline static error_t MyTimerC$TogLed1$postTask(void ){
#line 56
  unsigned char __nesc_result;
#line 56

#line 56
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(MyTimerC$TogLed1);
#line 56
...
#line 56
inline static error_t MyTimerC$TogLed0$postTask(void ){
#line 56
  unsigned char __nesc_result;
#line 56

#line 56
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(MyTimerC$TogLed0);
#line 56
...
static inline void MyTimerC$Timer1$fired(void )
{
  sim_log_debug(114U, "MyTimerC", "Periodic Timer 1 fired @ %s.\n", sim_time_string());
  MyTimerC$TogLed0$postTask();
  MyTimerC$TogLed1$postTask();
  MyTimerC$time[sim_node()]++;
  if (MyTimerC$time[sim_node()] >= 5) {
      sim_log_debug(115U, "MyTimerC", "Timer1 Stops \n");
      MyTimerC$Timer1$stop();
    }
}
...
# 72 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40b6d3a8){
#line 72
  switch (arg_0x40b6d3a8) {
#line 72
    case 0U:
#line 72
      MyTimerC$Timer0$fired();
#line 72
      break;
#line 72
    case 1U:
#line 72
      MyTimerC$Timer1$fired();
#line 72
      break;
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40b6d3a8);
#line 72
      break;
#line 72
    }
...
#line 46
  {
    sim_log_debug(116U, "Init", "LEDS: initialized.\n");
...
# 53 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void MyTimerC$Timer1$startPeriodic(uint32_t dt){
#line 53
...
static inline void MyTimerC$Boot$booted(void )
{
  sim_log_debug(109U, "MyTimerC", "Telos B Boot at: @ %s \n", sim_time_string());
  MyTimerC$Timer0$startOneShot(5120);
  MyTimerC$Timer1$startPeriodic(2048);
}

# 49 "/opt/tinyos-2.1.1/tos/interfaces/Boot.nc"
inline static void SimMainP$Boot$booted(void ){
#line 49
  MyTimerC$Boot$booted();
#line 49
}
#line 49
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module MyTimerC */
  if (!strcmp(varname, "MyTimerC$counter"))
  {
    *addr = (uintptr_t)&MyTimerC$counter[__nesc_mote];
    *size = sizeof(MyTimerC$counter[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MyTimerC$time"))
  {
    *addr = (uintptr_t)&MyTimerC$time[__nesc_mote];
    *size = sizeof(MyTimerC$time[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module MyTimerC */
  MyTimerC$counter[__nesc_mote] = 0;
  MyTimerC$time[__nesc_mote] = 0;
